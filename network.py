...
class Network(object):
    ...
    def pairwise_and(self, a, b):
        ...
        and return [3,3,3],through the matrix ,we can easy to caculate c_k - c_i(appear in the paper of semilar adaptation)
        """
    ...
    def cross_loss(self, features, labels, keep_prob):
        """
        this in case you don't want to use the correlation loss function and label aware loss function
        """
